...
| `ATLAS-LINEAGE-READ-001` / `WRITE-001` | classified repository operation | 0.90 x table confidence |
| `ATLAS-LINEAGE-REPOSITORY-003` | unclassified repository operation (`uses`) | 0.70 x table confidence |
